(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('rxjs'),require('@ngrx/store'),exports, require('@ngrx/store'), require('rxjs'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@ngrx/effects', ['@angular/core','rxjs','@ngrx/store','exports', '@ngrx/store', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (global = global || self, factory(global.ng.core,global.rxjs,global.ngrx.store,(global.ngrx = global.ngrx || {}, global.ngrx.effects = {}), global.store, global.rxjs, global.rxjs.operators, global.ng.core));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, store, rxjs, operators, core) { 'use strict';
